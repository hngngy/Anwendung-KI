...
with zipfile.ZipFile("efficientnet-b7-isic.zip", 'r') as zip_ref:
    zip_ref.extractall("efficientnet-b7-isic")

print(" Modellordner entpackt: ./efficientnet-b7-isic")

# Schritt 7.2: Modell ggf. laden statt neu trainieren
model_path = "./efficientnet-b7-isic"
...
# Schritt 8: Modell laden (EfficientNet-B7)
...
for epoch in range(EPOCHS):
    ...
    if avg_val_loss < best_val_loss:
        ...
        early_stopping_counter = 0
        model.save_pretrained("./efficientnet-b7-isic")
        processor.save_pretrained("./efficientnet-b7-isic")
        print("Modell gespeichert (lokal unter ./efficientnet-b7-isic)")

        # Modellordner zippen
        import shutil
        shutil.make_archive("efficientnet-b7-isic", 'zip', "./efficientnet-b7-isic")
        print("Modell als ZIP-Datei gespeichert: efficientnet-b7-isic.zip")
