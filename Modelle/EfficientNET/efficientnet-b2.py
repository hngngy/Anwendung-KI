...
with zipfile.ZipFile("efficientnet-b2-isic.zip", 'r') as zip_ref:
    zip_ref.extractall("efficientnet-b2-isic")

print("Modellordner entpackt: ./efficientnet-b2-isic")

# Schritt 7.2: Modell ggf. laden statt neu trainieren
model_path = "./efficientnet-b2-isic"
...
for epoch in range(EPOCHS):
    ...
    if avg_val_loss < best_val_loss:
        ...
        early_stopping_counter = 0
        model.save_pretrained("./efficientnet-b2-isic")
        processor.save_pretrained("./efficientnet-b2-isic")
        print("Modell gespeichert (lokal unter ./efficientnet-b2-isic)")

        # Modellordner zippen
        import shutil
        shutil.make_archive("efficientnet-b2-isic", 'zip', "./efficientnet-b2-isic")
        print("Modell als ZIP-Datei gespeichert: efficientnet-b2-isic.zip")
