...
with zipfile.ZipFile("efficientnet-b3-isic.zip", 'r') as zip_ref:
    zip_ref.extractall("efficientnet-b3-isic")

print("Modellordner entpackt: ./efficientnet-b3-isic")

# Schritt 7.2: Modell ggf. laden statt neu trainieren
model_path = "./efficientnet-b3-isic"
...
for epoch in range(EPOCHS):
    ...
    if avg_val_loss < best_val_loss:
        ...
        early_stopping_counter = 0
        model.save_pretrained("./efficientnet-b3-isic")
        processor.save_pretrained("./efficientnet-b3-isic")
        print("Modell gespeichert (lokal unter ./efficientnet-b3-isic)")

        # Modellordner zippen
        import shutil
        shutil.make_archive("efficientnet-b3-isic", 'zip', "./efficientnet-b3-isic")
        print("Modell als ZIP-Datei gespeichert: efficientnet-b3-isic.zip")
