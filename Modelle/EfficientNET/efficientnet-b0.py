...
with zipfile.ZipFile("efficientnet-b0-isic.zip", 'r') as zip_ref:
    zip_ref.extractall("efficientnet-b0-isic")

print(" Modellordner entpackt: ./efficientnet-b0-isic")

# Schritt 7.2: Modell ggf. laden statt neu trainieren
model_path = "./efficientnet-b0-isic"
...
for epoch in range(EPOCHS):
    ...
    if avg_val_loss < best_val_loss:
        ...
        early_stopping_counter = 0
        model.save_pretrained("./efficientnet-b0-isic")
        processor.save_pretrained("./efficientnet-b0-isic")
        print("Modell gespeichert (lokal unter ./efficientnet-b0-isic)")

        # Modellordner zippen
        import shutil
        shutil.make_archive("efficientnet-b0-isic", 'zip', "./efficientnet-b0-isic")
        print("Modell als ZIP-Datei gespeichert: efficientnet-b0-isic.zip")
