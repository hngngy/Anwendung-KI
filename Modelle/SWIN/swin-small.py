...
with zipfile.ZipFile("swin-small-isic.zip", 'r') as zip_ref:
    zip_ref.extractall("swin-small-isic")

print("Modellordner entpackt: ./swin-small-isic")

# Schritt 7.5: Modell ggf. laden statt neu trainieren
model_path = "./swin-small-isic"
...
# Schritt 8: Modell laden (Swin-Small)
...
for epoch in range(EPOCHS):
    ...
    if avg_val_loss < best_val_loss:
        ...
        early_stopping_counter = 0
        model.save_pretrained("./swin-small-isic")
        processor.save_pretrained("./swin-small-isic")

        # Modellordner zippen
        import shutil
        shutil.make_archive("swin-small-isic", 'zip', "./swin-small-isic")
        print("Modell als ZIP-Datei gespeichert: swin-small-isic.zip")
