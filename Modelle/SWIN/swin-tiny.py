...
with zipfile.ZipFile("swin-tiny-isic.zip", 'r') as zip_ref:
    zip_ref.extractall("swin-tiny-isic")

print(" Modellordner entpackt: ./swin-tiny-isic")

# Schritt 7.2: Modell ggf. laden statt neu trainieren
model_path = "./swin-tiny-isic"
...
for epoch in range(EPOCHS):
    ...
    if avg_val_loss < best_val_loss:
        ...
        early_stopping_counter = 0
        model.save_pretrained("./swin-tiny-isic")
        processor.save_pretrained("./swin-tiny-isic")
        print("Modell gespeichert (lokal unter ./swin-tiny-isic)")

        # Modellordner zippen
        import shutil
        shutil.make_archive("swin-tiny-isic", 'zip', "./swin-tiny-isic")
        print("Modell als ZIP-Datei gespeichert: swin-tiny-isic.zip")
