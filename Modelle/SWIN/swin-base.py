...
with zipfile.ZipFile("swin-base-isic.zip", 'r') as zip_ref:
    zip_ref.extractall("swin-base-isic")

print(" Modellordner entpackt: ./swin-base-isic")

# Schritt 7.2: Modell ggf. laden statt neu trainieren
model_path = "./swin-base-isic"
...
for epoch in range(EPOCHS):
    ...
    if avg_val_loss < best_val_loss:
        ...
        early_stopping_counter = 0
        model.save_pretrained("./swin-base-isic")
        processor.save_pretrained("./swin-base-isic")
        print("Modell gespeichert (lokal unter ./swin-base-isic)")

        # Modellordner zippen
        import shutil
        shutil.make_archive("swin-base-isic", 'zip', "./swin-base-isic")
        print("Modell als ZIP-Datei gespeichert: swin-base-isic.zip")
